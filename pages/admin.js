...
export const initAdminPage = async () => {
  ...
  try {
    await loadAll(); populateSettings(); populateTopupSettings(); renderAll(); installPhoneVerificationCenter(); installPendingCenter(); bindTabs(); bindEditModal(); bindStaticImagePreviews(); bindAddForms(); bindSettingsForms(); bindTopupForms(); bindActions(); bindFeaturedDragDrop(); bindBackup();
